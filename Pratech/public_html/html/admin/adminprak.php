...
<head>
    ...
    <body>
        ...
        <section id="interface">
            ...
            <p class="i-name">Data Kuota Praktikum</p>
            <div class="status">
              <!-- Data Praktikum  -->
                <div class="container">
                  <div style="display:flex; margin-left: 30px;">
                    <div>
                    	<a href="tambah_sh.php"><button class="shift">Tambah Shift</button></a>
                    </div>
                  ...
                  <table class="schedule-table table table-bordered table-responsive-md" id="search-results">
                      ...
                      <tbody class="table-light align-items-center">
                          <?php
                            ...
                            $no=1;
                            $ambildata = mysqli_query($conn,"select * from kuota_prak");
                            while ($tampil =mysqli_fetch_array($ambildata)){
                                echo"
                                <tr>
                                    <td>$no</td>
                                    <td colspan='3'>$tampil[nama_prak]</td>
                                    <td >$tampil[hari]</td>
                                    <td colspan='1'>$tampil[shift]</td>
                                    <td>$tampil[kuota]</td>
                                    <td scope='row' colspan='2'>
                                    <a href='?kode=$tampil[id_tambah_sh]&confirm=yes' onclick='return confirmDelete()'>
                                    <button type='button' class='hapus'>Hapus</button>
                                    </a>
                                    <a href='edit_kuota.php?kode=$tampil[id_tambah_sh]'>
                        ...
                        <?php
                            ...
                            if (isset($_GET['kode']) && isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
                                mysqli_query($conn, "DELETE FROM kuota_prak WHERE id_tambah_sh = '$_GET[kode]'");
                                // Mengarahkan pengguna kembali ke halaman adminjadwal_maha.php setelah menghapus
                                echo "<script>window.location.href = 'adminprak.php';</script>";
                            }
                        ?> 
                      </tbody>
        ...
        <script>
            ...
            function showDataDeletedNotification() {
                alert('Data Praktikum Sudah Dihapus');
            }
        </script>
        <script>
