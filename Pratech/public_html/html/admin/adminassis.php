...
<head>
    ...
    <body>
        ...
        <section id="interface">
            ...
            <p class="i-name">Data Jadwal Ngajar</p>
            <div class="status">
              <!-- Data Praktikum  -->
                <div class="container">
                  <div style="display:flex; margin-left: 30px;">
                  <a href="tambah_ngajar.php"><button class="shift">Tambah Ngajar</button></a>
                ...
                <table class="schedule-table table table-bordered table-responsive-md" id="search-results">
                  <thead>
                      <tr>
                          <th scope="col">NO</th>
                          <th scope="col"colspan='4'>Praktikum</th>
                          <th scope="col"colspan='2'>Nim</th>
                          <th scope="col" colspan='4'>Nama</th>
                  ...
                  <tbody class="table-light align-items-center">
                       <?php
                        ...
                        $no=1;
                        $ambildata = mysqli_query($conn, "SELECT jadwal_ngajar.*, praktikum.nama_prak FROM jadwal_ngajar INNER JOIN praktikum ON jadwal_ngajar.id_praktikum = praktikum.id_praktikum");
                        while ($tampil = mysqli_fetch_array($ambildata)) {
                            ...
                            echo "
                                <tr>
                                    <td>$no</td>
                                    <td colspan='4'>$tampil[nama_prak]</td>
                                    <td colspan='2'>$tampil[nim]</td>
                                    <td colspan='4'>";
                        ...
                        <?php
                            ...
                            if (isset($_GET['kode']) && isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
                                mysqli_query($conn, "DELETE FROM jadwal_ngajar WHERE nim = '$_GET[kode]'");
                                // Mengarahkan pengguna kembali ke halaman adminjadwal_maha.php setelah menghapus
                                echo "<script>window.location.href = 'adminassis.php';</script>";
                            }
                        ?>
                  </tbody>
        ...
        <script>
            ...
            function showDataDeletedNotification() {
                alert('Data Jadwal Ngajar Sudah Dihapus');
            }
        </script>
        <script>
