...
<head>
    ...
    <body>
        ...
        <section id="interface">
            ...
            <p class="i-name">Data Jadwal Kuliah</p>
            <div class="status">
              <!-- Data Praktikum  -->
                <div class="container">
                ...
                <table class="schedule-table table table-bordered table-responsive-md" id="search-results">
                  ...
                  <?php
                    ...
                    $no = 1;
                    $ambildata = mysqli_query($conn, "SELECT DISTINCT jadwal_mahasiswa.nim, users.name, jadwal_mahasiswa.hari, jadwal_mahasiswa.shift FROM jadwal_mahasiswa INNER JOIN users ON jadwal_mahasiswa.nim = users.nim");
                    ...
                    if (isset($_GET['kode']) && isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
                        mysqli_query($conn, "DELETE FROM jadwal_mahasiswa WHERE nim = '$_GET[kode]'");
                        // Mengarahkan pengguna kembali ke halaman adminjadwal_maha.php setelah menghapus
                        echo "<script>window.location.href = 'adminjadwal_maha.php';</script>";
                    }
                    ?>
                  </tbody>
        ...
        <script>
            ...
            function showDataDeletedNotification() {
                alert('Data Jadwal Kuliah Sudah Dihapus');
            }
        </script>
        <script>
