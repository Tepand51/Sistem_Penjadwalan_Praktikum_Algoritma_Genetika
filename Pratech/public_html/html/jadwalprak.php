...
<head>
    ...
    <title>PraTech</title>
        ...
        <script src="../assets/generateSchedule.js"></script>
    ...
    <body>
        ...
        <section id="interface">
            ...
            <p class="i-name">Jadwal Praktikum</p>
            <div class="status">
                <div class="status">
                        <div class="container" style="display: block;">
                            ...
                            <ul style="display: block; margin-left: 30px;">
                              <li class="isi_ket">Pastikan Anda telah memeriksa hasil jadwal praktikum setelah mengeklik tombol generate sebelum melakukan submit.</li>
                              <li class="isi_ket">Jadwal praktikum akan ditampilkan dalam tabel dengan latar belakang berwarna hijau.</li>
            ...
            <div class="status">
                <div class="latar_tombol" style="display: block; ">
                    <div style="display: flex; ">
                        <div type="button" id="callPHP" class="generate" onclick="callPHP()">generate</div>
        ...
        <script>
            ...
            function showConfirmation() {
                ...
                if (isConfirmed) {
                    ...
                    // Tambahkan kode aksi menyimpan data ke database (jika diperlukan)
                } else {
