...
<head>
    ...
    <title>PraTech</title>
        ...
        <script type="text/javascript" src="../assets/inputSchedule.js"></script>
    ...
    <body>
                ...
                <div class="container" >
                  <div style="display:flex; margin-left: 30px;">
                    ...
                    <select id="categoryDropdown" class="pilihan">
                      ...
                      <option value="Praktikum Teknik Komputer I">Praktikum Teknik Komputer 1</option>
                      <option value="Praktikum Teknik Komputer II">Praktikum Teknik Komputer 2</option>
                      <option value="Praktikum Teknik Komputer III">Praktikum Teknik Komputer 3</option>
                      <option value="Praktikum Teknik Komputer IV">Praktikum Teknik Komputer 4</option>
                    </select>
                    </div>
        ...
        <script src="../assets/checkPraktikanKuliah.js"></script>
    </body>
</html>