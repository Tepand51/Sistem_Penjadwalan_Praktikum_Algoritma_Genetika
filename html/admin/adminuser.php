...
<head>
    ...
    <body>
        ...
        <section id="interface">
            ...
            <p class="i-name">Data User</p>
            <div class="status">
              <!-- Data Praktikum  -->
                <div class="container">
                  <div style="display:flex; margin-left: 30px;">
                    <div>
                    	<a href="tambah_user.php"><button class="shift">Tambah User</button></a>
                    </div>
                      ...
                      <?php
                        ...
                        echo "
                            <tr>
                                ...
                                <td scope='row' colspan='2'>
                                    <a href='?kode=$tampil[id_user]&confirm=yes' onclick='return confirmDelete()'>
                                        <button type='button' class='hapus'>Hapus</button>
                                    </a>
                                    <a href='edit_user.php?kode=$tampil[id_user]'>
                        ...
                        <?php
                            ...
                            if (isset($_GET['kode']) && isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
                                mysqli_query($conn, "DELETE FROM users WHERE id_user = '$_GET[kode]'");
