...
<head>
    ...
    <body>
        ...
        <section id="interface">
                ...
                <div class="container" style="display: flex; justify-content: center;align-items: center; ">
                    ...
                    <div class="container">
                        <div class="split" style="width:auto; ">
                            <div>
                                <img src="../image/pic-6.jpg" class='profile'style="width: 100px; height: auto;" alt="Finding fisdas">
                            </div>
                            <div >
                                <?php
                                    $nameArray = explode(' ', $name);
            ...
            <div class="status">
                <div class="container" style="justify-content: center; align-items: center; background: #2c3e50;">
